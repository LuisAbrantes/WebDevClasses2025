...
function ClassesList() {
    ...
    function measureText(text) {
        ...
        // Ajuste a fonte de acordo com o estilo aplicado ao input
    ...
    useEffect(() => {
        ...
        // Se o texto estiver perto do limite, aumente gradualmente a barra
        if (textWidth + 40 >= inputWidth && inputWidth < 600) {
            setInputWidth(prevWidth => Math.min(prevWidth + 50, 600));
        }
        // Reduz a largura se ficar muito espaço sobrando
        ...
        <section className="mb-20 bg-white py-10 px-6 rounded-xl shadow-sm border border-gray-100">
            <div className="flex items-center mb-6">
                <button
                    ...
                    className="mr-4 flex items-center text-gray-800 hover:text-[#A51C30]"
                >
                    <span
                    ...
                    <h2 className="text-3xl font-serif font-semibold ml-2">
                        Classes
                    </h2>
                </button>
